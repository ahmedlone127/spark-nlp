...
class BertForTokenClassificationTestSpec extends AnyFlatSpec {
  ...
  "BertForTokenClassification" should "be saved and loaded correctly" taggedAs LocalTest in {
    ...
    Benchmark.time("Time to save BertForTokenClassification model") {
      pipelineModel.stages.last
        .asInstanceOf[BertForTokenClassification]
        .write
        .overwrite()
        .save("./tmp_bertfortoken_model")
    }
    ...
    val loadedSequenceModel = BertForTokenClassification.load("./tmp_bertfortoken_model")
