...
class BertForQuestionAnsweringTestSpec extends AnyFlatSpec {
  ...
  "BertForQuestionAnswering" should "correctly load custom model with extracted signatures" taggedAs LocalTest in {
    ...
    val questionAnswering = BertForQuestionAnswering
      .pretrained()
  ...
  "BertForQuestionAnswering" should "run end to end pipeline test" taggedAs SlowTest in {
  ...
  "BertForQuestionAnswering" should "be saved and loaded correctly" taggedAs LocalTest in {
    ...
    Benchmark.time("Time to save BertForQuestionAnswering pipeline model") {
      pipelineModel.write.overwrite().save("./tmp_forquestionanswering_pipeline")
    }

    Benchmark.time("Time to save BertForQuestionAnswering model") {
      pipelineModel.stages.last
        .asInstanceOf[BertForQuestionAnswering]
        .write
        .overwrite()
  ...
  "BertForQuestionAnswering" should "benchmark test" taggedAs LocalTest in {
    ...
    Benchmark.time("Time to show BertForQuestionAnswering results") {
      pipelineDF.select("answer").show(10, false)
    }

    Benchmark.time("Time to save BertForQuestionAnswering results") {
      pipelineDF
