...
class XlmRoBertaSentenceEmbeddings(AnnotatorModel,
    ...
    *This paper shows that pretraining multilingual language models at scale leads to significant performance gains
    ...
    @staticmethod
    def pretrained(name="sent_xlm_roberta_base", lang="xx", remote_loc=None,engine="onnx"):
        ...
        return ResourceDownloader.downloadModel(XlmRoBertaSentenceEmbeddings, name, lang, remote_loc,engine)
