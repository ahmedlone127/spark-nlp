...
class XlnetForSequenceClassification(AnnotatorModel,
    ...
    @staticmethod
    def pretrained(name="xlnet_base_sequence_classifier_imdb", lang="en", remote_loc=None,engine ="onnx"):
        ...
        return ResourceDownloader.downloadModel(XlnetForSequenceClassification, name, lang, remote_loc,engine)
