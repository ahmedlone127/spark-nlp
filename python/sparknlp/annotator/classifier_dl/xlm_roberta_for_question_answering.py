...
class XlmRoBertaForQuestionAnswering(AnnotatorModel,
    ...
    def __init__(self, classname="com.johnsnowlabs.nlp.annotators.classifier.dl.XlmRoBertaForQuestionAnswering",
                 java_model=None):
        super(XlmRoBertaForQuestionAnswering, self).__init__(
            classname=classname,
    ...
    def loadSavedModel(folder, spark_session):
        ...
        XlmRoBertaForQuestionAnswering
            The restored model
        """
        from sparknlp.internal import _XlmRoBertaQuestionAnsweringLoader
        jModel = _XlmRoBertaQuestionAnsweringLoader(folder, spark_session._jsparkSession)._java_obj
