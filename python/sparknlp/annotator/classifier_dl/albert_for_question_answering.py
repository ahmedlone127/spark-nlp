...
class AlbertForQuestionAnswering(AnnotatorModel,
    ...
    The default model is ``"albert_base_qa_squad2"``, if no name is
    provided.
    ...
    def loadSavedModel(folder, spark_session):
        ...
        AlbertForQuestionAnswering
            The restored model
        """
        from sparknlp.internal import _AlbertQuestionAnsweringLoader
        jModel = _AlbertQuestionAnsweringLoader(folder, spark_session._jsparkSession)._java_obj
