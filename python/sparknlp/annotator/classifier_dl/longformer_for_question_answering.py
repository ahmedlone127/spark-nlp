...
class LongformerForQuestionAnswering(AnnotatorModel,
    ...
    The default model is ``"longformer_base_base_qa_squad2"``, if no name is
    provided.
    ...
    def loadSavedModel(folder, spark_session):
        ...
        LongformerForQuestionAnswering
            The restored model
        """
        from sparknlp.internal import _LongformerQuestionAnsweringLoader
        jModel = _LongformerQuestionAnsweringLoader(folder, spark_session._jsparkSession)._java_obj
